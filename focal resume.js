...
<head>
	...
	<link rel="stylesheet" href="./focal resume.css">
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="single-target-box">
						<h1>Values</h1>
						Lorem ipsum dolor sit amet, ea doming until epicuri iudicabit nam, te usu virtute placerat. Purto brute disputando cu est. </div>
				</div>
				<div class="col-lg-4">
					<div class="single-target-box">
						<h1>goals</h1>
	...
	<div class="footer-area">
     ...
     <!--End Contact-->
<script src="./j queary.min.js"></script>
	<script src="../resume/propper.min.js"></script>
	<script src="./bootstrap.min.js"></script>
	<script src="./carousel.css"></script>
